...
namespace IE5120.exchange
{
    public partial class ExchangeBooksDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            string sql = "select distinct b.ISBN,b.Title,b.Publisher,b.Author,b.Year,u.username,u.email,u.id from User_Books ub,Book b,Users u where ub.isbn=b.ISBN and u.id=ub.id and b.ISBN='"+isbn+"' and ub.id != '"+uid+"'";
