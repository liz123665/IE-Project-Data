    ...
    public partial class MyBooks : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                con.Open();
                string sql = "select ub.id,b.ISBN,b.Title,b.Publisher from Book b,User_Books ub where ub.id='" + id + "' and b.ISBN=ub.isbn";
        ...
        protected void DataPager1_PreRender(object sender, EventArgs e)
        {
            ...
            MySqlConnection con = new MySqlConnection(conn);
            con.Open();
            string sql = "select ub.id,b.ISBN,b.Title,b.Publisher from Book b,User_Books ub where ub.id='" + id + "' and b.ISBN=ub.isbn and b.Title like '%" + keyword + "%'";
            //create database connection and initialize sql commond, this sql commond is to
            //select the books user have already posted to book list
