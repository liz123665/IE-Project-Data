    ...
    public partial class ExchangeBooks : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {           
                ...
                string sql = "select distinct b.ISBN,b.Title,b.Publisher,b.Author,b.Year,b.Culture from User_Books ub,Book b where ub.isbn=b.ISBN and b.Culture like '%"+book_culture+"%' and ub.id!='"+uid+"'";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = "select distinct b.ISBN,b.Title,b.Publisher,b.Author,b.Year,b.Culture from User_Books ub,Book b where ub.isbn=b.ISBN and b.Culture like '%" + book_culture + "%' and b.Title like '%" + keyword + "%' and ub.id!='"+uid+"'";
            //initialize sql query, access isbn,book title, publisher, author, publish year and culture
